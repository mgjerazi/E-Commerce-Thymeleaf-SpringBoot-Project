...
public class ProductServiceImpl implements ProductService {
    ...
    public void createDummyProducts() {
        ...
        Product womanProduct10 = Product.builder()
                ...
                .categoryId(womenCategory.getId())
                .name("Yellow Sandals")
                .description("Yellow Faux Snake Stiletto Sandals")
                .price(32)
                .views(2)
                .image("women/yellow-faux-snake-stiletto-sandals.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct11 = Product.builder()
                ...
                .description("White Leather Look Toe Post Sandals")
                .price(22)
                .views(2)
                .image("women/wide-fit-white-leather-look-toe-post-sandals.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct12 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("Black Suede Strappy Flat Sandals")
                .description("Black Suede Strappy Flat Sandals")
                .price(20)
                .views(2)
                .image("women/wide-fit-black-suede-strappy-flat-sandals.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct13 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("White Heart Satin Wrap Mini Dress")
                .description("White Heart Satin Wrap Mini Dress")
                .price(25)
                .views(2)
                .image("women/white-heart-satin-wrap-mini-dress.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct14 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("Pale Grey Lace Pleated Halter Maxi Dress")
                .description("Pale Grey Lace Pleated Halter Maxi Dress")
                .price(48)
                .views(2)
                .image("women/tfnc-pale-grey-lace-pleated-halter-maxi-dress.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct15 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("Tan Straw Effect Floppy Hat")
                .description("Tan Straw Effect Floppy Hat")
                .price(15)
                .views(2)
                .image("women/tan-straw-effect-floppy-hat.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct16 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("Red Leopard Print High Neck Tiered Dress")
                .description("Red Leopard Print High Neck Tiered Dress")
                .price(37)
                .views(2)
                .image("women/red-leopard-print-high-neck-tiered-dress.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct17 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("Pink Vanilla Bright Pink Bardot Mini Bodycon Dress")
                .description("Pink Vanilla Bright Pink Bardot Mini Bodycon Dress")
                .price(34)
                .views(2)
                .image("women/pink-vanilla-bright-pink-bardot-mini-bodycon-dress.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct18 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("Pink Floral Wrap Midi Dress")
                .description("Pink Floral Wrap Midi Dress")
                .price(30)
                .views(2)
                .image("women/pink-floral-wrap-midi-dress.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
        ...
        Product womanProduct19 = Product.builder()
                .createdAt(LocalDateTime.now())
                .categoryId(womenCategory.getId())
                .name("White Stripe Boucle Mini Skirt")
                .description("White Stripe Boucle Mini Skirt")
                .price(20)
                .views(2)
                .image("women/off-white-stripe-boucle-mini-skirt.jpg")
                .sale(false)
                .featured(false)
                .featureImage("")
                .size("S,M,L,Xl,XXL")
